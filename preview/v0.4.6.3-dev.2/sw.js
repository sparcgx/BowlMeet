const PREVIEW_CACHE_ROOT='bowlmeet-preview-v0463d2-';
const CACHE=PREVIEW_CACHE_ROOT+'dynamic-grid-shell';
const RUNTIME=PREVIEW_CACHE_ROOT+'dynamic-grid-runtime';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./assets/liquid-glass-dev4.css?v=0463d2','../../icons/icon-192.png','../../icons/icon-512.png','../../icons/icon-maskable-512.png'];
